  ...
  data: [
    {
      ...
      file1: "https://firebasestorage.googleapis.com/v0/b/dagingue-dc5c9.appspot.com/o/about%2Fabout-us.jpg?alt=media&token=1dde0094-7e2e-40e5-a843-24e99623dc35",
      file2: "https://firebasestorage.googleapis.com/v0/b/dagingue-dc5c9.appspot.com/o/about%2Fbulgogi.jpg?alt=media&token=bb184693-d403-4863-993e-654a3e835925",
...
export const handler = [
  ...
  http.post(apiUrl + "/api/potong", () => {
    return HttpResponse.json({ message: "success add new data" }, { status: 200 });
  }),
  // get potong
...
export const errorHandler = [
  ...
  // edit bumbu
  http.put(apiUrl + "/api/bumbu/:id", async () => {
    return HttpResponse.json({ message: "failed edit data" }, { status: 400 });
  }),
